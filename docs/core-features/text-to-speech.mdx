...
For more precise control over pronunciation and additional paralanguage features like pauses and breathing, see [Fine-grained Control](/docs/core-features/fine-grained-control).
