...
For more advanced control over speech generation, including phoneme-level control and additional paralanguage features, see [Fine-grained Control](/docs/core-features/fine-grained-control).
...
Our state-of-the-art [S1 model](/docs/models-pricing/models-overview)
...
For real-time streaming, see the [WebSocket guide](/docs/sdk-reference/javascript/websocket).
...
- [Fine-grained control](/docs/core-features/fine-grained-control) for phoneme-level control and paralanguage
- [Voice cloning](/docs/sdk-reference/javascript/voice-cloning) for custom voices
- [WebSocket streaming](/docs/sdk-reference/javascript/websocket) for real-time apps
- [Guide and Best Practices](/docs/core-features/text-to-speech) for production use
