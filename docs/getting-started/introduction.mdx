...
<Tip>
    ...
    **OpenAudio S1:** Our latest model delivers unparalleled naturalness and emotion, setting a new standard for AI-generated speech. [Learn more about our models →](/docs/models-pricing/models-overview)
</Tip>
