...
<Note>
This guide assumes you have already [installed Fish Audio locally](/docs/self-hosting/local-setup) or [set up Docker deployment](/docs/self-hosting/docker-deployment).
</Note>
...
If you're using Docker deployment, refer to the [Docker Deployment guide](/docs/self-hosting/docker-deployment) for detailed instructions on:
...
4. See [Voice Cloning Best Practices](/docs/best-practices/voice-cloning)
...
- **[Emotion Control Best Practices](/docs/best-practices/emotion-control)** - Master expressive speech
- **[Voice Cloning Best Practices](/docs/best-practices/voice-cloning)** - Optimize voice cloning quality
