...
- **[Set up Docker deployment](/docs/self-hosting/docker-deployment)** - Use containerized deployment for easier management
- **[Run inference](/docs/self-hosting/running-inference)** - Start generating speech with your local models
