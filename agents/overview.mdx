...
<Note>
  Agents is in public beta. Every Fish Audio account can use it: open
  [Agents](https://fish.audio/app/agents) in the console to get started.
  Features and APIs may still change before general availability.
</Note>
...
| --------------- | ------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| **Console**     | Design, test, and publish agents visually, with no code.                                                   | [Configuration](/agents/build/configuration)    |
