...
- **Output language**: fixed per agent, chosen from the same [52 languages](/agents/build/voice-language#speaking-language) as the speaking language. Default is English.
