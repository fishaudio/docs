  ...
  [
    {
      ...
      "msg": "Value error, system_prompt exceeds 32000 tokens (got 33001)",
      "ctx": { "error": "system_prompt exceeds 32000 tokens (got 33001)" }
    }
  ]
  ```
...
| `402`  | Out of API credit                                                        | Top up. Only session creation and phone-number purchase charge up front, so a `402` never leaves a partial charge. |
