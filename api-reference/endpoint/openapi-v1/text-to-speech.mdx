...
To upload audio clips directly, without pre-uploading, serialize the request body with MessagePack as per the [instructions](/docs/core-features/text-to-speech#direct-api-usage).
</Warning>
