...
<Note>
  This page is an orientation map of the web app. Use the links below to open
  each tool. To build with code instead, see the
...
<CardGroup cols={2}>
  ...
  <Card title="Pronunciation Dictionaries" icon="book-open" href="https://fish.audio/app/pronunciation-dictionary">
    Create, preview, and publish reusable pronunciation rules. Follow the
    [dictionary guide](/developer-guide/core-features/fine-grained-control/pronunciation-dictionaries)
    to use a published version in TTS requests.
  </Card>
</CardGroup>
