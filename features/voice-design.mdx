...
Voice Design is billed once per successful generation request, not once per candidate. Authentication errors, validation errors, insufficient API credit, concurrency limits, service-side errors, and empty candidate responses are not billed.
