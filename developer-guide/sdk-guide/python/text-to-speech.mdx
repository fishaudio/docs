...
{/* speak-mintlify-hash: 8449d7e9db3c781cf36b33bb4913e5b883353cb2fde48a7c5ac1670fbbd6feb5 */}
<Visibility for="humans">
  <AudioTranscript page="python-text-to-speech" />
</Visibility>
...
config = TTSConfig(
    ...
    max_new_tokens=1024,               # Max tokens generated per chunk
    repetition_penalty=1.2,            # >1.0 reduces repetition
    min_chunk_length=50,               # Min chars before a new chunk
    condition_on_previous_chunks=True, # Cross-chunk voice consistency
    early_stop_threshold=1.0,          # Batch early-stop threshold
)
...
Common exceptions include [`RateLimitError`](/api-reference/sdk/python/exceptions#ratelimiterror-objects), [`NotFoundError`](/api-reference/sdk/python/exceptions#notfounderror-objects), [`APIError`](/api-reference/sdk/python/exceptions#apierror-objects), and the base [`FishAudioError`](/api-reference/sdk/python/exceptions#fishaudioerror-objects). Invalid request parameters surface as an `APIError` with `status == 422`.
