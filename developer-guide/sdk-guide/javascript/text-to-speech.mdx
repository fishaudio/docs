...
Our state-of-the-art [S1 model](/developer-platform/models-pricing/models-overview)
...
For real-time streaming, see the [WebSocket guide](/sdk-reference/javascript/websocket).
...
- [Voice cloning](/sdk-reference/javascript/voice-cloning) for custom voices
- [WebSocket streaming](/sdk-reference/javascript/websocket) for real-time apps
