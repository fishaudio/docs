...
<Note>
  ...
  guide](/developer-guide/sdk-guide/javascript/installation) for its current
  surface.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Realtime WebSocket" icon="bolt" href="/developer-guide/sdk-guide/python/websocket">
