...
<Tabs>
  <Tab title="OpenAI">
    ...
    covering transcription, chat audio, the Realtime WebSocket, and what each
    feature supports.
  ...
  <Tab title="OpenRouter">
    ...
    covering transcription, the model catalog, and what each feature supports.
  ...
  <Tab title="ElevenLabs">
    ...
    covering speech-to-text, timestamps, realtime streaming, your voice
    library, and what each feature supports.
  ...
  <Tab title="Groq">
    <Steps>
      ...
      <Step title="Swap the base URL and generate">
        The Groq SDK appends `/openai/v1` itself, so give it the bare `/compat`
        base:
