...
<Tabs>
  ...
  <Tab title="Install from a direct URL">
    ```bash
    npx skills add https://docs.fish.audio/.well-known/agent-skills/fish-audio-api
    ```

    Useful if your tooling prefers a fully qualified URL or you want to pin to a specific skill path.
  </Tab>
</Tabs>
