...
<Visibility for="humans">
  <AudioTranscript page="best-practices-emotion-control" />
</Visibility>
...
See the [Emotion Control guide](/developer-guide/core-features/emotions) for the full list of supported emotions.
